<template>
	<div class="diy_home diy_list diy_rent_out_application" id="diy_rent_out_application_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/rent_out_application/details?rent_out_application_id=' + o['rent_out_application_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/rent_out_application/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/rent_out_application/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						租客用户
							...
							<th class="diy_title" v-if="$check_field('get','reasons_for_rent_cancellation')">
						退租原因
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','reasons_for_rent_cancellation')">
						<span>
							{{ o["reasons_for_rent_cancellation"] }}
						</span>
					</td>
					</tr>
			</table>
		...
		data() {
			return {
						...
						richList: [
								{
									title: "退租原因",
									name: "reasons_for_rent_cancellation",
									type: "多文本"
								},
						],
											// 用户列表
