<template>
	<div class="diy_home diy_list diy_payment_information" id="diy_payment_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/payment_information/details?payment_information_id=' + o['payment_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/payment_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/payment_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
						<th class="diy_title" v-if="$check_field('get','payment_no')">
						缴费号
					</th>
						...
						租客用户
							...
							<th class="diy_title" v-if="$check_field('get','payment_name')">
						缴费名称
					</th>
							<th class="diy_title" v-if="$check_field('get','payment_amount')">
						缴费金额
					</th>
							<th class="diy_title" v-if="$check_field('get','payment_date')">
						缴费日期
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						<td class="diy_field diy_text" v-if="$check_field('get','payment_no')">
						<span>
							{{ o["payment_no"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','payment_name')">
						<span>
							{{ o["payment_name"] }}
						</span>
					</td>
							<td class="diy_field diy_number" v-if="$check_field('get','payment_amount')">
						<span>
							{{ o["payment_amount"] }}
						</span>
					</td>
							<td class="diy_field diy_date" v-if="$check_field('get','payment_date')">
						<span>
							{{ $toTime(o["payment_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
					</tr>
			</table>
